						...
						<table class="table table-striped">
							...
							@foreach($videos as $video)
								<tr>
									...
									<td>
										<a href="/admin/public-courses/{{ $course->id }}/videos/edit/{{ $video->id }}" class="genric_btn warning">Edit</a>
										<button id="{{ $course->id }}" class="genric_btn danger delete_public_course_video_button">Delete</button>
									</td>
								</tr>
							@endforeach
						</table>
			...
			@else
				<div class="col-lg-7 col-md-8 col-sm-10 col-12">
					<div class="gray-box">
						...
						<a href="/admin/public-courses/{{ $course->id }}/videos/new" class="genric_btn primary centered">Add Content</a>
					</div>
				</div>
			@endif
		</div>
