<!-- Hero section -->
<section class="hero-section set-bg" data-setbg="{{ URL::asset('img/bg.jpg') }}">
	<div class="container" style="margin: auto;">
		...
		{{-- <div class="row">
			<div class="col-lg-10 offset-lg-1" style="padding: 24px; background: black;">
				<h3 class="text-center text-white mb-4">Sign up for our Free Intro Course</h3>
				<form class="intro-newslatter">
					...
					<div class="row mt-4">
						<div class="col-lg-4 offset-lg-4 col-md-4 offset-md-4 col-sm-12 col-12">
							<input type="submit" class="site-btn center-button">
						</div>
					</div>
				</form>
			</div>
